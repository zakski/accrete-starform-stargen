...
import com.hippsoretribution.controlP5.ControlP5;
import com.hippsoretribution.controlP5.drawable.controllers.Group;
import com.hippsoretribution.controlP5.drawable.controllers.Tab;
import com.hippsoretribution.controlP5.drawable.controllers.press.Button;
import com.hippsoretribution.controlP5.drawable.controllers.text.TextField;
import com.hippsoretribution.controlP5.events.control.ControlEvent;
import com.hippsoretribution.controlP5.events.control.ControlListener;
...
public class FormStarGUI implements ControlListener {
	...
	public FormStarGUI(FormStarApplet applet, MousePointer pointer, KeyStorage storage, boolean shorts) {
		parent = applet;
		cp5 = new ControlP5(applet, pointer, storage);
	...
	private void addGlobals() {
		...
		seedText.setInputFilter(ControlP5.INTEGER);
		...
		timeButton.setSize(80, 20).getCaptionLabel().align(ControlP5.CENTER, ControlP5.CENTER);
		...
		randomButton.setSize(80, 20).getCaptionLabel().align(ControlP5.CENTER, ControlP5.CENTER);
