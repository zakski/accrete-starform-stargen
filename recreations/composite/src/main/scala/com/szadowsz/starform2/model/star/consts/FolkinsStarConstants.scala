...
/**
  ...
  */
class FolkinsStarConstants extends StarConstants {
  ...
  /**
    * The cummulative total of starCounts
    */
  val cumulStarCounts: Array[Array[Double]] = cummulativeCounts()
  ...
  /**
    ...
    * by the total.
    */
  private def cummulativeCounts() : Array[Array[Double]] = {
    val total = starCounts.foldLeft(0.0) { case (t, a) => t + a.sum }
    var cumulative = 0.0
