...
/**
  * Base trait for Star Generation Calculations based on Fogg's Paper. These Functions are widely used despite the means to generate mass and luminosity
  * differing.
  *
  * @author Zakski : 10/09/2016.
  */
trait StarCalc[S <: Star, C <: StarConstants] {

  val sConst : C

  def buildStar(rand : RandGenTrait): S
