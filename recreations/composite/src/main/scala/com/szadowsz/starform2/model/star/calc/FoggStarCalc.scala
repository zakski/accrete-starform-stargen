...
/**
  * Star Generation Calculations based on Fogg's Paper. Also at least partly used by Burdick, Burrell, Keris and Webb.
  *
  *
  * @note Burdick uses all Fogg's calculations.
  * @note Burrell uses the luminosity calculation when not deferring to user input.
  * @note Webb uses these calculations when not deferring to user input.
  *
  * Created on 13/04/2017.
  */
abstract class FoggStarCalc[S <: FoggStar, C <: FoggStarConstants](c : C) extends StarCalc[S,C] {

  override val sConst : C = c
  ...
  /**
    ...
    * @see method luminosity, line 255 in  Star.java - Carl Burke (starform)
    *
