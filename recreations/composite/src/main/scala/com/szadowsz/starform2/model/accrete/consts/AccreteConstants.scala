...
trait AccreteConstants {
  ...
  /**
    ...
    * @note Sagan states that varying the planetismal seed mass from Dole's original value has no appreciable effect on the final results.
    *
    * @see p. 15, Formation of Planetary Systems by Aggregation: A Computer Simulation - Stephen H. Dole
    * @see p. 10, Computer Simulations of Planetary Accretion: Dynamics Sensitivity to Initial Conditions - Isaacman & Sagan
  ...
  /**
    ...
    * @note Scale should probably be between 50.0 and 100.0. Though K as low as 10 can allow for the generation of plausible systems.
    * @note input parameter for the accretion process. value was chosen for its ability to replicate our solar system; other values may not produce desired
    *       output.
    *
    * @see p. 14, Formation of Planetary Systems by Aggregation: A Computer Simulation - Stephen H. Dole
    * @see p. 12, Computer Simulations of Planetary Accretion: Dynamics Sensitivity to Initial Conditions - Isaacman & Sagan
