package com.szadowsz.starform2.model.eco.calc

import com.szadowsz.starform2.model.eco.consts.Atmosphere.Atmosphere
import com.szadowsz.starform2.model.eco.consts.{Atmosphere, EcoConstants}
import com.szadowsz.starform2.rand.gen.RandGenTrait
import com.szadowsz.starform2.unit.{UnitConstants, UnitConverter}
...
trait EcoCalc extends UnitConstants {
  ...
  def moleculeLimit(mass: Double, escapeVel: Double, equat_radius: Double): Double = {
