        ...
        number routines and for testing it on other machines and to Marty Shannon
        (m...@mozart.att.com) for the lisp-style output format.

        As a warning, don't be surprised if the program take a while to run.  Here
        are some sample run times:
                2-5 seconds user time on my HP9000/350
                5-30 seconds on a Sun-3/60
                5-8 seconds on an 8087-equipped 10MHz IBM-T
                4 minutes on an 8 MHz IBM-PC
                7 minutes on a normal IBM-PC

        If you don't have verbose mode on, no output will appear until all of the
        calculations are done, so don't be surprised if it doesn't appear to do
        ...
        ----------------------------------------------------------------------
         I can be reached at the email address burdic...@hplabs.hp.com
        ----------------------------------------------------------------------
