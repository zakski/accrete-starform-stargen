...
20	SCREEN 2
30	RANDOMIZE
40	DIM STO (500), SWP (25,5), V$(25), HLD(25,5),U$1251
50	INPUT "max e ",E: INPUT "steer mass ",MS: INPUT
"dust ".D:INPUT "gas '',G
60	IFE=OTHENE -.4
70	IF MS=0THENMS= 1
80	IFD-OTHEN D=1
...
120	R -(110) (MS-.331
130	U=R'.33)
140	STO(1)=D•1.5•R`R•EXP(-51•U)
150	NEXTI
160 SM=STOI500)
170	IN -3•SORILS):IN=INT(IN): IF IN <.5 THEN IN = 1
