...
public class SolarConst {
    ...
    public static final double EARTH_DENSITY = 5.52;    // Units of g/cc
    public static final double EARTH_RADIUS = 6.378E8;    // Units of cm
    public static final double CHANGE_IN_EARTH_ANG_VEL = -1.3E-15;    // Units of radians/sec/year
    public static final double EARTH_AXIAL_TILT = 23.4;    // Units of degrees

    public static final double J = 1.46E-19;    // Used in day-length calcs (cm2/sec2 g)
