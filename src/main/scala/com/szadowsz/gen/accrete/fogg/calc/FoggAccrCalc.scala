...
import com.szadowsz.gen.accrete.base.calc.{AccreteCalc, PlanetesimalCalc}
...
trait FoggAccrCalc extends AccreteCalc {
  this: PlanetesimalCalc with FoggStarCalc with FoggConstants =>
  ...
  override def dustCloudDensity(radius: Double): Double = {
    // TODO check if changes to A are correct
