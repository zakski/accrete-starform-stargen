...
/**
 * Pull in necessary calculations via the Companion Object
 */
protected object Planetismal extends OrbitalCalc with UnitConstants
...
trait Planetismal {
  ...
  /**
    ...
    * @note unit of value is AU.
    */
  def perihelion: Double = Planetismal.perihelionDistance(axis,ecc)
  ...
  /**
    ...
    * @note unit of value is AU.
    */
  def aphelion: Double = Planetismal.aphelionDistance(axis,ecc)
  ...
  override def hashCode(): Int = {
    axis.hashCode() ^ mass.hashCode() ^ ecc.hashCode()
  }
