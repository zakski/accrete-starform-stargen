package com.szadowsz.starform.model.accrete.body

import com.szadowsz.starform.model.accrete.GravityCalc
import com.szadowsz.starform.system.planets.Planetismal
import com.szadowsz.starform.system.star.Star

/**
  * Class to represent an accreting proto planetary body. Adds variable mass/axis/ecc to the Planetismal trait to allow
  * for easier alteration during the accretion process.
  *
 ...
 * 
  ...
  */
class ProtoPlanet(val star : Star, val calc: GravityCalc, var mass: Double, var axis: Double, var ecc: Double) extends Planetismal {
