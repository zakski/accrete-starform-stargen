...
// Some inline functions moved here to reduce program weight
inline double inner_effect_limit(double a, double e, double mass)
{
...
inline double outer_effect_limit(double a, double e, double mass)
{
...
int dust_available(double inside_range, double outside_range)
{
	...
	dust_here=(current_dust_band==NULL) ? FALSE : (current_dust_band->dust_present);
...
void update_dust_lanes(double min, double max, double mass, double crit_mass,
...
double collect_dust(double last_mass, double a, double e, double crit_mass,
...
void accrete_dust(double &seed_mass, double a, double e, double crit_mass,
		  double body_inner_bound, double body_outer_bound)
{
	double
		new_mass,
...
planet_pointer distribute_planetary_masses(double stellar_mass_ratio,
						double stellar_luminosity_ratio, double inner_dust, double outer_dust)
{
...
planet_pointer distribute_moon_masses
