...
long double day_length(planet_pointer, long double, int);
...
long double radius_improved(long double, long double, long double, int, int);
long double gas_radius(long double, long double, long double, long double, planet_pointer);
long double gas_dwarf_radius(planet_pointer, sun*);